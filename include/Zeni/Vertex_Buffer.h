...
namespace Zeni {
  ...
  public:
    ...
    virtual void add_rectangle(Renderable *rectangle) = 0; ///< Add a Rectangle to the Vertex_Buffer
  ...
  public:
    ...
    virtual void add_rectangle(Renderable *rectangle); ///< Add a Rectangle to the Vertex_Buffer
