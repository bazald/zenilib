...
#define GUARANTEED_FINISHED_BEGIN(TASK) {Recursive_Mutex::Lock GF_lock(TASK.done_mutex()); {Condition_Variable &GF_condition = TASK.done_condition(); const bool &GF_done = TASK.done_variable(); while(!GF_done) GF_condition.wait(GF_lock);} {
